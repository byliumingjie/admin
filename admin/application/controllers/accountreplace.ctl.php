...
class accountreplace_Controller extends Module_Lib {
	...
	**/
	...
	{ 
	 	$zoneid = (int)Helper_Lib::getCookie('gzoneid');//获取平台ID 
		// $platform = Helper_Lib::getCookie('zoneid');//获取平台ID
        $global_platform = 1;//唯一
        
       	isset($_POST['type'])?$_POST['type']:0;//设置类型（1-挂载 2-账号变更修改uin）
        ...
        {	
       	     ...
       	     $platform = Platfrom_Service::getServer();
        	 //$serverOut = Server_Service::getServer();
		  	 //$servertype['db']= $dbname;	
