...
class GameActivity_Controller extends Module_Lib{
	...
	public function __construct($conn='')
	{
		...
		$this->mode = new  GameActivity_Model($conn);
	}
	/**
	 * 活动列表信息
	 * **/
	public function ActivityIndex()
	{
		...
		$this->load_view("dev/activity/list",$data);
    ...
    {  
		...
		"ResetType"   => $ResetType,
		"ResetTime"   => $ResetTime,
		"rules"       => "'".json_encode($InrulesList,JSON_UNESCAPED_UNICODE)."'",
		"createtime"  => "'".date('Y-m-d H:i:s',time())."'"
   	 	];
