...
class AccountReplace_Model extends Model{
    ...
    private $db = null;
    private $cdd = null; 	
    private $Accountdbname =array(13=>'accountdb_ios_s1',14=>'accountdb_android_ios',15=>'accountdb_tx_s1',16=>'accountdb_xy_s1');
	...
	public static function  verifyAccount($platform,$accountID,$accountType){ 
		...
		$tables= $platform['db'].'.t_qmonster_accountdata';		 
	...
	public static  function get_accoutType($platform)
	{
		...
		$sql ="select `name`,type from tb_account_types";
		if($obj->cdd->query($sql) && $obj->cdd->rowcount() > 0){
