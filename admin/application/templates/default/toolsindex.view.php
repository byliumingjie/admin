                    ...
                    <div class="widget-content">
                        <ul class="quick-actions">
                            ...
                            <li>
                                <i>
                                    <!-- //index  showmail-->
                                    <a href="/GlobalConfig/index" title="进入" class="tip-bottom"><i
                                                class="icon-search"></i>活动配置信息</a>
                                </i>
                            <li>
                                <i>
                                    <!-- //index  showmail-->
                                    <a href="/GlobalConfig/createConfig" title="进入" class="tip-bottom"><i
                                                class="icon-search"></i>新增活动配置</a>
                                </i>
                            </li>
                            <li>
                                <i>
                                    <!-- //index  showmail-->
                                    <a href="/Channel/index" title="进入" class="tip-bottom"><i class="icon-search"></i>渠道配置</a>
                                </i>
                            </li>
                            <!--<li>
                                <i>

                                    <a href="/loginnotice/passLoginNotice" title="进入" class="tip-bottom"><i
                                                class="icon-search"></i>登录公告</a>
                                </i>
                            </li>-->
                        </ul>
                    </div>
