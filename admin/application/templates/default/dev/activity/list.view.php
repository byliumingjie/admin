...
$insert_html .= Page_Lib::loadJs('activity-file-load','','dev');;
...
<div id="content-header">
	...
	<a class="btn btn-large tip-bottom" title="创建活动" id="addName" href="CreateActivityIndex">
...
<?php echo DevToolbox_Lib::ActivityHtml();?> 
	  ...
	  <div class="span12">
        ...
        <div class="widget-content tab-content">
	        <div id="tab1" class="tab-pane">
				...
				<?php echo DevToolbox_Lib::ActivityTableHtml();?>
				    <tbody>
				    <!--统计数据项 begin-->
				      <?php   $j = 0; ?>
				        <?php foreach ($UntreatedList as $var): ?> 
				            <tr>      
								...
								<?php  echo ($var['stoptime']==0)?0:date('Y-m-d H:i:s',$var['stoptime']);?></td>
...
<form action="CreateActivityIndex" method="post" id="activityEditForm">
...
<!--活动发布 -->
<?php $activityOut = Activity_Service::getActivityInfo();?>
	            ...
	            <div class="control-group" >			    
					    ...
					    <div class="control-group">
							 <select class="form-control"  id="liOption"  multiple="multiple"  
									...
									<?php $vardat = '"'.$var['id'].'-'.$var['serverId'].'"';?>
