...
//$wechatName =0;
$username = 'ovDA6v2_zvnVpjQofPotQ3GJZe5s';
...
<html lang="en" class="no-js"> 
    ...
    <body>
        ...
        <div class="page-container">
            <h1>礼包领取</h1>
            <form action="account_award.php" method="post" id="UserForm">
				<!---<div> 
                ...
                <button id="submit" type="button" name='sut'>领取</button>
            </form>
            <div class="connect">
