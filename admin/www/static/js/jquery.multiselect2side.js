	...
	jQuery.fn.multiselect2side = function (o) {
		...
		return this.each(function () {
			...
			var divUpDown =
					...
					"</div>";
			if(o.platId && o.platId!='undefined')
			 { 
				 var name = $("#"+o.platId).attr("data-type-name");
				 
				 if(name!='undefined' && name!='' &&  name=='platId')
				 {
					 o.labelsx='待选平台';
					 o.labeldx='已选平台';
				 }   
				 else if(name!='undefined' && name!='' &&  name=='ReleaseActivityId'){
					 o.labelsx='待选活动';
					 o.labeldx='已选活动';
				 }
			 }
